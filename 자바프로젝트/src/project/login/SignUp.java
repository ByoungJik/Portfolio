...
public class SignUp {
	...
	/**
	 * 회원가입 하려는 정보를 사용자로부터 입력 받는 메소드입니다.
	 * @author주혜원
	 */
	...
	/**
	 * 장르  유효성 검사에 필요한 메소드들입니다.
	 * 장르 의외에 다른 단어가 들어올 경우 제한을 두는 메소드입니다.
	 * @author 주혜원
	 */
