...
public class AdminCommunity {
	...
	/**
	 * 관리자 카테고리 중 작품 리스트를 출력해주는 클래스입니다.
	 * 
	 * @author 마지연
	 */
	...
	public boolean add(String path) {
		...
		System.out.printf("제목 : %s\r\n감독 : %s\r\n배우 : %s\r\n상영 일정 : %s\r\n평점 : %s\r\n장르 : %s\r\n",
				titleName, dirName, actName, playTime, evaluate, genreVal);
		System.out.println();
	...
	/**
	 * 관리자 카테고리 중 금지어 리스트 추가해주는 클래스입니다.
	 * 
	 * @author 마지연
	 */
