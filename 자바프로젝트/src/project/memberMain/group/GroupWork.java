...
public class GroupWork {
	...
	*/
	...
	/**
	 * 게시물의 선택지 리스트를 출력해주고 선택지를 입력 받는 메소드 입니다.
	 * @auther 남건희
	*/
	...
	/**
	 * 모임 탈퇴 선택지 리스트를 출력해주고 선택한 모임을 탈퇴 해주는 메소드입니다.
	 * @auther 남건희
	*/
...
//			String path = "data\\마이페이지\\user01\\info.txt";
	...
	/**
	 * 모임 가입 선택지를 출력해주고 모임을 가입해주는 메소드 입니다.
	 * @auther 남건희
	*/
...
//			String path = "data\\마이페이지\\user01\\info.txt";
	...
	/**
	 * 선택한 모임을 입력 받고 그 모임의 게시물 리스트를 출력해주는 메소드 입니다.
	 * @auther 남건희
	*/
	...
	*/
	...
	/**
	 * 유저가 선택한 게시물의 수정/삭제 선택지를 출력하고 입력 값을 받는 메소드 입니다.
	 * @auther 남건희
	*/
	...
	/**
	 * 유저가 선택한 모임의 새 게시물을 만드는 메소드 입니다.
	 * @auther 남건희
	*/
	...
	/**유저가 선택한 게시물의 댓글을 추가 할 수 있는 메소드 입니다.
	 * @auther 남건희
	*/
	...
	/**
	 * 유저가 선택한 모임의 게시물을 출력해주는 메소드 입니다.
	 * @auther 남건희
	*/
