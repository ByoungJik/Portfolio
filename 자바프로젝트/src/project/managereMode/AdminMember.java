...
public class AdminMember {
	...
	// 1. 회원 검색
	/**
	 * 관리자가 회원을 검색 하고 싶을때, 아이디를 입력하고 그 회원의 정보를 출력하는 메소드입니다.
	 * @author 주혜원
	 */
	public void findMem() {
	...
	/**
	 * 관리자가 블랙리스트에 있는 블랙리스트 명단을 출력하는 메소드 입니다.
	 * @author 주혜원
	 */
	...
	// 블랙리스트 추가하는 메소드
	/**
	 * 관리자가 기존 유저들중 블랙리스트에 추가 시키는 메소드 입니다.
	 * @author 주혜원
	 */
	...
	// 3. 로그인 통계
	/**
	 * 관리자가 회원과 비회원의 로그인 통계를 볼 수 있게 출력해주는 메소드입니다.
	 * @author 주혜원
	 */
