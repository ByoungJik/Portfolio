...
public class AdminMoim {
	...
	/**
	 * 관리자 모임 중 모임 추가하는 클래스입니다.
	 * @param listPath 모임 리스트 경로
	 * @param path 게시물 리스트를 받기위한 경로
	 * @author 마지연
	 */
	...
	// path = 모임 폴더 경로
	/**
	 * 관리자 모임 중 모임 게시물 / 댓글 관리하는 클래스입니다.
	 * @param listPath 모임 리스트 경로
	 * @param path 게시물 리스트를 받기위한 경로
	 * @author 마지연
	 */
