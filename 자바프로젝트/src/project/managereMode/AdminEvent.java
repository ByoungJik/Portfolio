...
public class AdminEvent {
	...
	/**
	 * 관리자 이벤트 중 이벤트 리스트 출력해주는 클래스입니다.
	 * @param path 파일 경로
	 * @return
	 * @author 마지연
	 */
	...
	/**
	 * 관리자 이벤트 중 이벤트 삭제/수정하기 위해 선택지 출력하는 클래스입니다.
	 * 
	 * @author 마지연
	 */
	...
	private static void adminAlterEvent(int c) {
		...
		try {
			if (c > 0 && c < groups.length + 1) {
				...
				String path1 = String.format("data\\게시물 수정\\%s", groups[c - 1].getName());
	...
	*/
	...
	/**
	 * 관리자 이벤트 중 금지어를 다른 문자로 대체하는 클래스입니다.
	 * 
	 * @author 마지연
	 */
